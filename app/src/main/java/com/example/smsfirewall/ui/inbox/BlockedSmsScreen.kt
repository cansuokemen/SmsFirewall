                ...
                when (screen) {
                    ...
                    ScreenState.SETTINGS -> {
                        SettingsScreen(
                            ...
                            blockedKeywords         = viewModel.blockedKeywords,
                            onAddBlockedKeyword     = { keyword -> viewModel.addBlockedKeyword(keyword) },
                            onRemoveBlockedKeyword  = { keyword -> viewModel.removeBlockedKeyword(keyword) },
